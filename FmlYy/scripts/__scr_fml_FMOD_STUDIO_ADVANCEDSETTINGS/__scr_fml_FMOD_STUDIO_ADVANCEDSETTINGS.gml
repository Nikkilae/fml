...
/// @param {buffer} buf
function __FMOD_STUDIO_ADVANCEDSETTINGS_serialize(settings, buf)
{
...
/// @param {FMOD_STUDIO_ADVANCEDSETTINGS} settings
/// @param {buffer} buf
function __FMOD_STUDIO_ADVANCEDSETTINGS_deserialize(settings, buf)
{
...
/// @param {FMOD_STUDIO_ADVANCEDSETTINGS} settings
/// @returns {pointer}
function __FMOD_STUDIO_ADVANCEDSETTINGS_as_buf_ptr(settings)
{
    static buf = buffer_create(0, buffer_grow, 1);
    buffer_seek(buf, buffer_seek_start, 0);
    __FMOD_STUDIO_ADVANCEDSETTINGS_serialize(settings, buf);
